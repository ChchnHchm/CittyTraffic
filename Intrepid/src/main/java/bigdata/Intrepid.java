...
public class Intrepid {
	...
	public static void main(String[] args) throws Exception {
        ...
        SparkSession spark = SparkSession.builder().appName("Spark_Dataframes_example").config("spark.master", "local").getOrCreate();
        ...
        for (File file : listOfFiles) {
                ...
                //format("com.crealytics.spark.excel").option("useHeader", true).option("header", true)
